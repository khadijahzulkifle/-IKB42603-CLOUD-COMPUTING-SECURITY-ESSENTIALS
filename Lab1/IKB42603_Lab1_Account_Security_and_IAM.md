...
![Admins group creation](STEP 2.1.png)
...
![Least privilege admin commands](STEP 2.2.png)
...
![CloudAdmin user creation](STEP 2.3.png)
...
![Verify Admins membership](STEP 2.4.png)
...
![Analyst user creation](STEP 3.1.png)
...
![Analyst read-only policy](STEP 3.3.png)
...
![Access key creation](STEP 4.1.png)
...
![Access key listing](STEP 4.2.png)
...
![Access key deactivation command](STEP 4.3.png)
...
![Session B cluster setup](STEP CLUSTER.png)
...
![Role and RoleBinding creation](STEP 6.png)
...
![RoleBinding YAML verification](Step 8.png)
